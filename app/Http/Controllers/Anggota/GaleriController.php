...
class GaleriController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('dashboard.anggota.galeri.index', compact('galeri'));
    }
    ...
    public function create()
    {
        ...
        return view('dashboard.anggota.galeri.create', compact('anggota'));
    }
    ...
    public function show(Galeri $galeri)
    {
        ...
        return view('dashboard.anggota.galeri.show', compact('galeri', 'averageRating'));
    }
    ...
    {
        $anggota = User::where('role', 'anggota')->get();
        return view('dashboard.anggota.galeri.edit', compact('galeri', 'anggota'));
    }
