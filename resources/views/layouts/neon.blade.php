        ...
        <aside class="sidebar fixed inset-y-0 left-0 z-30 w-64 overflow-y-auto py-6 px-4 shadow-xl lg:static lg:left-auto lg:top-auto lg:block lg:w-20 lg:overflow-y-visible lg:px-3 xl:w-64"
            ...
            <nav class="mt-2 space-y-1">
                ...
                <a href="{{ route('dashboard.admin.index')}}" 
                   class="nav-item group flex items-center rounded-lg py-3 px-4 {{ str_starts_with($currentRoute, 'dashboard.admin') ? 'text-white active' : 'text-gray-300 hover:text-white' }}">
                    <i class="fas fa-tachometer-alt text-lg {{ str_starts_with($currentRoute, 'dashboard.admin') ? 'text-neon-blue' : '' }}"></i>
                    <span class="ml-3 hidden xl:block">Dashboard</span>
                </a>
                
                <a href="{{ route('admin.anggota.index')}}" 
                   class="nav-item group flex items-center rounded-lg py-3 px-4 {{ str_starts_with($currentRoute, 'admin.anggota') ? 'text-white active' : 'text-gray-300 hover:text-white' }}">
                    <i class="fas fa-users text-lg {{ str_starts_with($currentRoute, 'admin.anggota') ? 'text-neon-blue' : '' }}"></i>
                    <span class="ml-3 hidden xl:block">Anggota</span>
                </a>
                ...
                <a href="{{ route('admin.galeri.index')}}" 
                    ...
                    <i class="fas fa-images text-lg {{ str_starts_with($currentRoute, 'admin.galeri') ? 'text-neon-blue' : '' }}"></i>
                    <span class="ml-3 hidden xl:block">Galeri</span>
                </a>
