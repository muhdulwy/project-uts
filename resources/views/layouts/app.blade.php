...
<body class="bg-gray-100 font-roboto relative bg-cover bg-center min-h-screen"
        ...
        <header class="relative z-10">
            <div class="container mx-auto p-6 flex justify-between items-center">
                ...
                <div class="flex items-center gap-x-4">
                    ...
                    <a class="text-white text-2xl font-bold leading-tight" href="/">
                        PPBI <br /> BANDA ACEH
                    </a>
                </div>
                ...
                <nav class="space-x-4">
                    <ul class="flex space-x-4 text-white">
                        <li><a class="hover:text-gray-300" href="/">Beranda</a></li>
                        <li class="relative">
                            <a id="profilButton" class="hover:text-gray-300 cursor-pointer">
                                Profil <i class="fas fa-caret-down"></i>
                            </a>
                            <ul id="profilMenu" class="absolute left-0 mt-2 w-48 bg-white text-gray-800 rounded shadow-lg hidden">
                                <li><a class="block px-4 py-2 hover:bg-gray-200" href="/anggota">Anggota</a></li>
                                <li><a class="block px-4 py-2 hover:bg-gray-200" href="/struktur">Struktur Organisasi</a></li>
                            </ul>
                        </li>
                        <li><a class="hover:text-gray-300" href="/berita">Berita</a></li>
                        <li><a class="hover:text-gray-300" href="/galeri">Galeri</a></li>
                        <li><a class="hover:text-gray-300" href="/testimonial">Testimonial</a></li>
                        <li><a class="hover:text-gray-300" href="/tentang">Tentang Kami</a></li>
                        @guest
    ...
    <!-- Main Content -->
    <main class="relative z-10 py-10 container mx-auto">
        @yield('content')
    </main>
    ...
    <footer class="bg-gray-900 text-white py-8">
        <div class="container mx-auto text-center">
            <div class="flex justify-center space-x-6 mb-4">
                <a class="hover:text-gray-400" href="#"><i class="fab fa-facebook"></i></a>
                <a class="hover:text-gray-400" href="#"><i class="fab fa-twitter"></i></a>
                <a class="hover:text-gray-400" href="#"><i class="fab fa-linkedin"></i></a>
                <a class="hover:text-gray-400" href="#"><i class="fab fa-google-plus"></i></a>
            </div>
