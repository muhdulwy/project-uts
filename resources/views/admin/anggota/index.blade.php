@extends('layouts.app', ['title' => 'anggota - Admin'])
        ...
        <div class="container mx-auto px-6 py-8">
            <div class="flex items-center">
                <button class="text-white focus:outline-none bg-gray-600 px-4 py-2 shadow-sm rounded-md">
                    <a href="{{ route('admin.anggota.create') }}">TAMBAH</a>
                </button>
                <div class="relative mx-4">
                    <span class="absolute inset-y-0 left-0 pl-3 flex items-center">
                        <svg class="h-5 w-5 text-gray-500" viewBox="0 0 24 24" fill="none">
                            <path d="M21 21L15 15M17 10C17 13.866 13.866 17 10  17C6.13401 17 3 13.866 3 10C3 6.13401 6.13401 3 10 3C13.866 3 17 6.13401
                                    17 10Z" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                        ...
                        <thead class="justify-between">
                            <tr class="bg-gray-600 w-full">
                                ...
                                <th class="px-16 py-2 text-left">
                                    <span class="text-white">NAMA ANGGOTA</span>
                                </th>
                                <th class="px-16 py-2 text-left">
                            ...
                            @forelse($anggotas as $anggota)
                                <tr class="border bg-white">
                                    <td class="px-16 py-2 flex justify-center">
                                        <img src="{{ $anggota->image }}" class="w-10 h-100 object-fit-cover rounded-full">
                                    </td>
                                    <td class="px-16 py-2">
                                        <!-- nama nya sesuikan di model-->
                                    ...
                                    <!-- Action untuk tombol hapus dan edit jangan lupa ditambahkan-->
                                    <td class="px-10 py-2 text-center">
                                        ...
                                        <button onClick="destroy(this.id)" id="{{ $anggota->id }}"
